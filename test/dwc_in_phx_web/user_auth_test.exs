defmodule DwcInPhxWeb.UserAuthTest do
  use DwcInPhxWeb.ConnCase

  alias DwcInPhx.Accounts
  alias DwcInPhx.Accounts.Scope
  alias DwcInPhxWeb.UserAuth

  import DwcInPhx.AccountsFixtures

  @remember_me_cookie "_dwc_in_phx_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, DwcInPhxWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
